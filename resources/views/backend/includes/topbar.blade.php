        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{asset('frontend/img/me4.png')}}" class="wd-32 rounded-circle" alt="">
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href=""><img src="{{asset('frontend/img/me4.png')}}" class="wd-80 rounded-circle" alt=""></a>
              ...
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{route('passwordchange')}}"><i class="icon ion-ios-person"></i> change password</a></li>
