      ...
      <div class="br-header-right">
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <img src="{{asset('frontend/img/me3.png')}}" class="wd-32 rounded-circle" alt="">
              <span class="logged-name hidden-md-down">{{Auth::guard('faculty')->user()->fname}}</span>
              
              <span class="square-10 bg-success"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-header wd-250">
              <div class="tx-center">
                <a href=""><img src="{{asset('frontend/img/me3.png')}}" class="wd-80 rounded-circle" alt=""></a>
                <h6 class="logged-fullname">{{Auth::guard('faculty')->user()->fname}}</h6>
                <p>{{Auth::guard('faculty')->user()->femail}}</p>
              </div>
             
              <hr>
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{route('fchangepassword')}}"><i class="icon ion-ios-person"></i>change Password</a></li>
                ...
                <form method="POST" action="{{route('faculty.logout')}}">
                            @csrf
                <li>
                  <a href="{{route('faculty.logout')}}" onclick="event.preventDefault();
